function fn() {
    ...
    config.projectTeamUrl = config.adminUri + 'projectTeam/';
    config.projectStateUrl = config.adminUri + 'projectState/';
    config.projectTypeUrl = config.adminUri + 'projectType/';
    config.taskStateUrl = config.adminUri + 'taskState/';
    config.projectUrl = config.adminUri + 'project/';
    config.taskUrl = config.adminUri + 'task/';
    config.projectCategoryUrl = config.adminUri + 'projectCategory/';
