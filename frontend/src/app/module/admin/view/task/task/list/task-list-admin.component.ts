...
export class TaskListAdminComponent implements OnInit {
    ...
    taskStates: Array<TaskStateDto>;
    assignedTos: Array<MemberDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TaskDto>();
    ...
    public async delete(dto: TaskDto) {
    ...
    public async duplicate(dto: TaskDto) {
    ...
    public exportPdf(dto: TaskDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'taskState?.libelle', header: 'Task state'},
            {field: 'assignedTo?.id', header: 'Assigned to'},
            {field: 'project?.code', header: 'Project'},
        ];
    }


    public async loadTaskState(){
        this.taskStateService.findAllOptimized().subscribe(taskStates => this.taskStates = taskStates, error => console.log(error))
    }
    public async loadAssignedTo(){
        this.memberService.findAll().subscribe(assignedTos => this.assignedTos = assignedTos, error => console.log(error))
    }
	...
	public initDuplicate(res: TaskDto) {
        if (res.subTasks != null) {
             res.subTasks.forEach(d => { d.task = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Task state': e.taskState?.libelle ,
                'Assigned to': e.assignedTo?.id ,
        ...
        //'Task state': this.criteria.taskState?.libelle ? this.criteria.taskState?.libelle : environment.emptyForExport ,
        //'Assigned to': this.criteria.assignedTo?.id ? this.criteria.assignedTo?.id : environment.emptyForExport ,
        //'Project': this.criteria.project?.code ? this.criteria.project?.code : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<TaskDto> {
        return this.service.selections;
    }

    set selections(value: Array<TaskDto>) {
