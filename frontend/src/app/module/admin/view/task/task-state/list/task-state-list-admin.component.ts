...
@Component({
  selector: 'app-task-state-list-admin',
  templateUrl: './task-state-list-admin.component.html'
})
export class TaskStateListAdminComponent implements OnInit {

    protected fileName = 'TaskState';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TaskStateDto>();
    ...
    public async edit(dto: TaskStateDto) {
    ...
    public async view(dto: TaskStateDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TaskStateDto) {
    ...
    public async duplicate(dto: TaskStateDto) {
    ...
    public exportPdf(dto: TaskStateDto): void {
...
// add
	...
	public initDuplicate(res: TaskStateDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TaskStateDto> {
        return this.service.selections;
    }

    set selections(value: Array<TaskStateDto>) {
