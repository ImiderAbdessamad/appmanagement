...
@Component({
  selector: 'app-task-state-view-admin',
  templateUrl: './task-state-view-admin.component.html'
})
export class TaskStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: TaskStateAdminService){
