...
export class ProjectCreateAdminComponent  implements OnInit {
   ...
   private _validProjectCode = true;
    ...
    const isPermistted = await this.roleService.isPermitted('ProjectTeam', 'add');
    if(isPermistted) {
    ...
    const isPermistted = await this.roleService.isPermitted('ProjectCategory', 'add');
    if(isPermistted) {
    ...
    const isPermistted = await this.roleService.isPermitted('ProjectType', 'add');
    if(isPermistted) {
