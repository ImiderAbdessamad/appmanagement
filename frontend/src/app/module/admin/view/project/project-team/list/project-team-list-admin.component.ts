...
@Component({
  selector: 'app-project-team-list-admin',
  templateUrl: './project-team-list-admin.component.html'
})
export class ProjectTeamListAdminComponent implements OnInit {

    protected fileName = 'ProjectTeam';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ProjectTeamDto>();
    ...
    public async edit(dto: ProjectTeamDto) {
    ...
    public async view(dto: ProjectTeamDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ProjectTeamDto) {
    ...
    public async duplicate(dto: ProjectTeamDto) {
    ...
    public exportPdf(dto: ProjectTeamDto): void {
...
// add
	...
	public initDuplicate(res: ProjectTeamDto) {
        if (res.members != null) {
             res.members.forEach(d => { d.projectTeam = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ProjectTeamDto> {
        return this.service.selections;
    }

    set selections(value: Array<ProjectTeamDto>) {
