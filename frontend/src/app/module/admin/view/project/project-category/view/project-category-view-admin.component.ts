...
@Component({
  selector: 'app-project-category-view-admin',
  templateUrl: './project-category-view-admin.component.html'
})
export class ProjectCategoryViewAdminComponent implements OnInit {
    ...
    constructor(private service: ProjectCategoryAdminService){
