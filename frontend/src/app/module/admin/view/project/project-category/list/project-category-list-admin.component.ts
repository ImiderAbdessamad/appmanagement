...
@Component({
  selector: 'app-project-category-list-admin',
  templateUrl: './project-category-list-admin.component.html'
})
export class ProjectCategoryListAdminComponent implements OnInit {

    protected fileName = 'ProjectCategory';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ProjectCategoryDto>();
    ...
    public async edit(dto: ProjectCategoryDto) {
    ...
    public async view(dto: ProjectCategoryDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ProjectCategoryDto) {
    ...
    public async duplicate(dto: ProjectCategoryDto) {
    ...
    public exportPdf(dto: ProjectCategoryDto): void {
...
// add
	...
	public initDuplicate(res: ProjectCategoryDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ProjectCategoryDto> {
        return this.service.selections;
    }

    set selections(value: Array<ProjectCategoryDto>) {
