...
@Component({
  selector: 'app-project-type-list-admin',
  templateUrl: './project-type-list-admin.component.html'
})
export class ProjectTypeListAdminComponent implements OnInit {

    protected fileName = 'ProjectType';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ProjectTypeDto>();
    ...
    public async edit(dto: ProjectTypeDto) {
    ...
    public async view(dto: ProjectTypeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ProjectTypeDto) {
    ...
    public async duplicate(dto: ProjectTypeDto) {
    ...
    public exportPdf(dto: ProjectTypeDto): void {
...
// add
	...
	public initDuplicate(res: ProjectTypeDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ProjectTypeDto> {
        return this.service.selections;
    }

    set selections(value: Array<ProjectTypeDto>) {
