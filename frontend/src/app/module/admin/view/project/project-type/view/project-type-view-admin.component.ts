...
@Component({
  selector: 'app-project-type-view-admin',
  templateUrl: './project-type-view-admin.component.html'
})
export class ProjectTypeViewAdminComponent implements OnInit {
    ...
    constructor(private service: ProjectTypeAdminService){
